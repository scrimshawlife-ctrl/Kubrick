...
SAMPLE = ROOT / "evals" / "retrieval" / "inputs" / "sample_melodrama_lowbudget.yaml"
PATTERN = (
    ROOT
    / "references"
    / "patterns"
...
class OpenClawPortabilityTests(unittest.TestCase):
    ...
    def test_json_retrieval_logs_outside_skill(self) -> None:
        brief = {
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            receipt = json.loads(result.stdout)["retrieval_receipt"]
    ...
    def test_prohibited_pattern_is_recorded(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            receipt = json.loads(result.stdout)["retrieval_receipt"]
            rejected = receipt["rejected_patterns"]
            self.assertTrue(
                any(
