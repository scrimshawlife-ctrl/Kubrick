#!/usr/bin/env python3
"""Run Kubrick's standalone OpenClaw regression suite.

The filename remains for upstream CLI compatibility.
"""
...
def main():
    ...
    summary={"suite":"kubrick-openclaw-evals","passed":sum(r["status"]=="PASS" for r in results),"failed":sum(r["status"]=="FAIL" for r in results),"results":results}
